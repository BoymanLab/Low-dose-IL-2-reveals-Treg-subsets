...
image_mat_sub <- image_mat %>% dplyr::select(ImageNumber, description) %>% separate(description, c("Lupus", "patient_id", "timepoint", "ROI"))
image_mat$description
...
saveRDS(sce,file = paste0(path.files, "sce_batch2.rds"))
```
